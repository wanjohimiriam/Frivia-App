// ignore_for_file: non_constant_identifier_names, unused_element, prefer_const_constructors, unused_field, no_leading_underscores_for_local_identifiers
...
class GamePage extends StatelessWidget {
   ...
   GamePage({super.key, required this.diffcultyLevel});
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (_context) =>
            GamePageProvider(context: context, difficultyLevel: diffcultyLevel),
        child: _Good_UI());
  }
